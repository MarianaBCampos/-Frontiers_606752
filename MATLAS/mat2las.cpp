 ...
 * CHANGE HISTORY:
     ...
     2013 -- First public matlas_tools version (pli & ep)
     2019 -- Read laz format > 5 and ExtraBytes *MNGW6.3 for Matlab 2018b and beyond.
...
/* create header */
    ...
    {
        header->x_scale_factor = fgiopts->x_scale_factor; //0.0001;
